...
if __name__ == '__main__':
    ...
    download_dir = "odi_batsman_records_1.csv" #name of the file to be generated
    ...
    get_series_data_with_decades_list = partial(get_series_data,decades_tuple,series_wise_matches)#creates a partial function with only url as input
